document.addEventListener("DOMContentLoaded", function () {
  ...
  for (let i = 0; i < zeros.length; i++) {
    zeros[i].addEventListener("click", function () {
      ...
      zeros[i].parentElement.querySelector(".feedback").innerHTML =
  ...
  for (let i = 0; i < ones.length; i++) {
    ones[i].addEventListener("click", function () {
      ...
      ones[i].parentElement.querySelector(".feedback").innerHTML =
  ...
  for (let i = 0; i < twos.length; i++) {
    twos[i].addEventListener("click", function () {
      ...
      twos[i].parentElement.querySelector(".feedback").innerHTML =
  ...
  for (let i = 0; i < threes.length; i++) {
    threes[i].addEventListener("click", function () {
      ...
      threes[i].parentElement.querySelector(".feedback").innerHTML =
        "This answer is worth 3 points!";
    });
  }
  ...
  for (let i = 0; i < fours.length; i++) {
    fours[i].addEventListener("click", function () {
      ...
      fours[i].parentElement.querySelector(".feedback").innerHTML =
        "This answer is worth 4 points!";
    });
  }
  ...
  for (let i = 0; i < fives.length; i++) {
    fives[i].addEventListener("click", function () {
      ...
      fives[i].parentElement.querySelector(".feedback").innerHTML =
